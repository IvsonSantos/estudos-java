...
/**
 * Uma classe de dez alunos se submeteu a um questionário. As notas (inteiros no
 * intervalo 0–100) para esse questionário estão disponíveis. Determine a média
 * da classe no questionário.
 */
public class ClassAverage {
	...
	public static void main(String[] args) {
		...
		while (gradeCounter <= 10) // faz o loop 10 vezes
		{
			...
			gradeCounter = gradeCounter + 1; // incrementa o contador por 1ÿ
		}
