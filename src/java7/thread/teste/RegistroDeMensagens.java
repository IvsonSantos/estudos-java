...
public class RegistroDeMensagens {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Collection<String> mensagens = new Vector<String>();		// Vector e thread safe
		// Collection<String> mensagens = new ArrayList<String>();   arrayList nao e Thread Safe
		Collection<String> mensagens = new HashSet<String>();		// utilizada com Syncronized é o melhor
		//Collection<String> mensagens = new LinkedList<String>();	// LinkedList e thread safe
